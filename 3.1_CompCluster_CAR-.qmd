...
pdf("plots_res_CAR-_patient.pdf")
plots
...
pdf("plots_res_CAR-_patientclin.pdf")
plots
plots$boxplot[[1]] + facet_wrap(~cell_group, nrow = 1, scales = "free")
dev.off()
...
pdf("plot_proportions_CLuster_CAR-.pdf", width = 10, height = 2)
plot1 + facet_wrap_custom(~cell_group, scales = "free", ncol = 11, scale_overrides = list(
  scale_override(1, expandy(plot1, n = 0.1, max.y = 0.2)),
  scale_override(2, expandy(plot1, n = 0.1, max.y = 0.4)),
  scale_override(3, expandy(plot1, n = 0.1, max.y = 0.6)),
  scale_override(4, expandy(plot1, n = 0.1, max.y = 0.3)),
  scale_override(5, expandy(plot1, n = 0.1, max.y = 0.4)),
  scale_override(6, expandy(plot1, n = 0.1, max.y = 0.4)),
  scale_override(7, expandy(plot1, n = 0.05, max.y = 0.1)),
  scale_override(8, expandy(plot1, n = 0.05, max.y = 0.2)),
  scale_override(9, expandy(plot1, n = 0.2, max.y = 0.6)),
...
pdf("plots_res_CAR-_patient_cd48.pdf")
plots
plots$boxplot[[1]] + facet_wrap(~cell_group, nrow = 1, scales = "free")
dev.off()
...
pdf("plots_res_CAR-_CAR-_cd48.pdf")
plots
plots$boxplot[[1]] + facet_wrap(~cell_group, nrow = 1, scales = "free")
dev.off()
