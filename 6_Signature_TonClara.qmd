---
title: "Signature Tonic Signaling CBueno genes"
author:
...
ggplot(aux_df1[which(aux_df1$final_criteria == "CD4"), ], aes(x = fct_reorder(Class1, Tonic.MGM1, .fun = median, .desc = TRUE), y = Tonic.MGM1, fill = Class1)) +
  geom_violin(scale = "width") +
  geom_boxplot(outlier.shape = NA, width = 0.1) +
  theme_classic() +
  theme(axis.text.x = element_text(size = 16), axis.text.y = element_text(size = 16)) +
...
ggplot(aux_df1[which(aux_df1$final_criteria == "CD8"), ], aes(x = fct_reorder(Class1, Tonic.MGM1, .fun = median, .desc = TRUE), y = Tonic.MGM1, fill = Class1)) +
  geom_violin(scale = "width") +
  geom_boxplot(outlier.shape = NA, width = 0.1) +
  theme_classic() +
  theme(axis.text.x = element_text(size = 16), axis.text.y = element_text(size = 16)) +
...
# Patient
ggplot(aux_df1, aes(x = fct_reorder(Patient_id, Tonic.MGM1, .fun = median, .desc = TRUE), y = Tonic.MGM1, fill = Patient_id)) +
  geom_violin(scale = "width") +
  geom_boxplot(outlier.shape = NA, width = 0.1) +
  theme_classic() +
  theme(axis.text.x = element_text(size = 16), axis.text.y = element_text(size = 16)) +
...
# Condition
ggplot(aux_df1, aes(x = fct_reorder(Condition, Tonic.MGM1, .fun = median, .desc = TRUE), y = Tonic.MGM1, fill = Condition)) +
  geom_violin(scale = "width") +
  geom_boxplot(outlier.shape = NA, width = 0.1) +
  theme_classic() +
  theme(axis.text.x = element_text(size = 16), axis.text.y = element_text(size = 16)) +
...
ggplot(aux_df1, aes(x = fct_reorder(ClinPat, Tonic.MGM1, .fun = median, .desc = TRUE), y = Tonic.MGM1, fill = ClinPat)) +
  geom_violin(scale = "width") +
  geom_boxplot(outlier.shape = NA, width = 0.1) +
  theme_classic() +
  theme(axis.text.x = element_text(size = 16), axis.text.y = element_text(size = 16)) +
...
DotPlot(integrated.obj, features = "Tonic.MGM1", group.by = "Patient_id") +
