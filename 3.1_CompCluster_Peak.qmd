...
integrated.obj <- subset(x = integrated.obj, subset = Timepoint == "Peak")
...
pdf("plots_res_Peak_patient.pdf")
plots
...
pdf("plots_res_Peak_patientclin.pdf")
plots
plots$boxplot[[1]] + facet_wrap(~cell_group, nrow = 1, scales = "free")
dev.off()
...
pdf("plot_proportions_Peak_CLuster.pdf", width = 10)
plot1 + facet_wrap_custom(~cell_group, scales = "free", ncol = 4, scale_overrides = list(
  scale_override(1, expandy(plot1, n = 0.1, max.y = 0.6)),
  scale_override(2, expandy(plot1, n = 0.1, max.y = 0.7)),
  scale_override(3, expandy(plot1, n = 0.05, max.y = 0.25)),
  scale_override(4, expandy(plot1, n = 0.05, max.y = 0.35)),
  scale_override(5, expandy(plot1, n = 0.1, max.y = 0.3)),
  scale_override(6, expandy(plot1, n = 0.05, max.y = 0.15)),
  scale_override(7, expandy(plot1, n = 0.05, max.y = 0.15)),
  scale_override(8, expandy(plot1, n = 0.05, max.y = 0.1)),
  scale_override(9, expandy(plot1, n = 0.025, max.y = 0.05)),
  scale_override(10, expandy(plot1, n = 0.05, max.y = 0.2))
))
dev.off()


pdf("plots_res_Peak_CAR+-_axis.pdf")
plots$boxplot[[1]] + facet_grid_paginate(. ~ cell_group, ncol = 1, nrow = 1, page = 10, scales = "free_y") + expandy(mm, n = 0.01, max.y = 0.02) + scale_fill_manual(values = "white")
plots$boxplot[[1]] + facet_grid_paginate(. ~ cell_group, ncol = 1, nrow = 1, page = 1, scales = "free_y") + expandy(mm, n = 0.1, max.y = 0.1) + scale_fill_manual(values = "white")
plots$boxplot[[1]] + facet_grid_paginate(. ~ cell_group, ncol = 1, nrow = 1, page = 2, scales = "free_y") + expandy(mm, n = 0.1, max.y = 0.2) + scale_fill_manual(values = "white")
plots$boxplot[[1]] + facet_grid_paginate(. ~ cell_group, ncol = 1, nrow = 1, page = 3, scales = "free_y") + expandy(mm, n = 0.01, max.y = 0.01) + scale_fill_manual(values = "white")
plots$boxplot[[1]] + facet_grid_paginate(. ~ cell_group, ncol = 1, nrow = 1, page = 4, scales = "free_y") + expandy(mm, n = 0.01, max.y = 0.01) + scale_fill_manual(values = "white")
plots$boxplot[[1]] + facet_grid_paginate(. ~ cell_group, ncol = 1, nrow = 1, page = 5, scales = "free_y") + expandy(mm, n = 0.01, max.y = 0.01) + scale_fill_manual(values = "white")
plots$boxplot[[1]] + facet_grid_paginate(. ~ cell_group, ncol = 1, nrow = 1, page = 6, scales = "free_y") + expandy(mm, n = 0.01, max.y = 0.01) + scale_fill_manual(values = "white")
plots$boxplot[[1]] + facet_grid_paginate(. ~ cell_group, ncol = 1, nrow = 1, page = 7, scales = "free_y") + expandy(mm, n = 0.01, max.y = 0.01) + scale_fill_manual(values = "white")
plots$boxplot[[1]] + facet_grid_paginate(. ~ cell_group, ncol = 1, nrow = 1, page = 8, scales = "free_y") + expandy(mm, n = 0.01, max.y = 0.01) + scale_fill_manual(values = "white")
plots$boxplot[[1]] + facet_grid_paginate(. ~ cell_group, ncol = 1, nrow = 1, page = 9, scales = "free_y") + expandy(mm, n = 0.01, max.y = 0.01) + scale_fill_manual(values = "white")
dev.off()
...
pdf("plots_res_Peak_patient_cd48.pdf")
plots
plots$boxplot[[1]] + facet_wrap(~cell_group, nrow = 1, scales = "free")
dev.off()
...
pdf("plots_res_Peak_CAR+-_cd48.pdf")
plots
plots$boxplot[[1]] + facet_wrap(~cell_group, nrow = 1, scales = "free")
dev.off()
